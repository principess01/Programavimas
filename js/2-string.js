...
// backtick (`) kabute leidzia kurti daugiaeilte teksta be \n ir \t plius galima naudoti ${} (veikia tik su backtick kabute)
...
// .length grazina skaiciu, kiek simboliu yra tekste (tarpai irgi yra simboliai)
...
console.log(text[7]);
console.log(text[8]);
console.log(text[9]); // undefined - nera tokio simbolio
console.log(text[-1]); // undefined - nera tokio simbolio

// Kad gauti siulomus zodziu pasirinkimus TAB+CTRL+RODYKLE I DESINE
